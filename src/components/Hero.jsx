    ...
    >
      ...
      <div className="relative z-20 w-full max-w-3xl flex flex-col items-center gap-5 sm:gap-6">
        ...
        <div className="inline-flex items-center gap-2 bg-white border border-gray-200
          ...
          <span className="truncate">people already on the waitlist</span>
        </div>

        {/* Headline */}
        <h1 className="text-[clamp(34px,6vw,76px)] font-black leading-[1.1]
        ...
        <p className="text-sm sm:text-base md:text-lg text-gray-500 max-w-md leading-relaxed">
          TrashGo makes waste pickup simple, reliable, and accessible in Sierra Leone.
          Join our early access waitlist — be first when we launch in your area.
        </p>
